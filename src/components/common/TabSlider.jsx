...
const CustomArrow = ({ className, onClick, direction, show }) => {
  ...
  return (
    <div
      className={`custom-arrow ${className} slick-${direction} bg-sisal-70 hover:bg-gray-700 text-black hover:text-white font-bold flex justify-center items-center rounded-full absolute z-10 ${
